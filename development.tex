...
\subsubsection{Bugs}
\begin{itemize}
\item  writing \verb+\abstract"+ creates \verb+\abstractname{"<}+ which is okay, BUT the last bracket is highlighted (highlighting of a single bracket without highlighting the whole pair, shouldn't even be possible).
